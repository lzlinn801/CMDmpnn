#####Install GROMACS 2020.3 in Linux#####
###Preparation###
...
###If you want to start from scratch, put all the .mdp files, protein.pdb, ligand.gro and ligand.itp files together and run the terminal###
gmx pdb2gmx -f protein.pdb -o processed.gro -p topol.top -ignh         ; Select AMBER14SB, SPC
...
gmx grompp -f em.mdp -c ions.gro -p topol.top -o em.tpr -maxwarn 1         ; Use the steep method to perform the first energy minimization
gmx mdrun -v -deffnm em
gmx grompp -f minim.mdp -c em.gro -p topol.top -o em2.tpr -maxwarn 1         ; Use the cg method to perform the second energy minimization
...
gmx grompp -f md.mdp -c npt.gro -r npt.gro -t npt.cpt -p topol.top -n index.ndx -o md_0_1.tpr -maxwarn 1         ; You can also use the .gro and .cpt files we provided to perform MD simulations directly. 
